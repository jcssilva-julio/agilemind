"""
Rotas legadas do AgileMind (RAG sobre PDF) — comportamento atual, ainda baseado
em estado global e persistência em pickle local.

NOTA DE MIGRAÇÃO: estas rotas serão migradas nas Fases 3–5 (Storage + Postgres,
visibilidade e isolamento por usuário) e protegidas por @login_required na Fase 2.
Por ora ficam aqui isoladas como blueprint, sem alterar o comportamento.
"""
import json
import pickle
import threading
...
# ── Configuração (será centralizada em config.py nas próximas fases) ──
import os
